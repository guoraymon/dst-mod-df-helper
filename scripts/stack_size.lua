TUNING.STACK_SIZE_LARGEITEM = GetModConfigData("stack_size")
TUNING.STACK_SIZE_MEDITEM = GetModConfigData("stack_size")
TUNING.STACK_SIZE_SMALLITEM = GetModConfigData("stack_size")
...
if GetModConfigData("IncreasedStackSize") > 63 then
