...
AddGlobalClassPostConstruct("widgets/inventorybar", "Inv", function()
    ...
    function Inv:LoadExtraSlots(self)
        ...
        if self.addextraslots == nil then
            ...
            self:AddEquipSlot(GLOBAL.EQUIPSLOTS.BACK, "modules/extra_equip_slots/images/back.xml", "back.tex")
            self:AddEquipSlot(GLOBAL.EQUIPSLOTS.NECK, "modules/extra_equip_slots/images/neck.xml", "neck.tex")
        -- else
